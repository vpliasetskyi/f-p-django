...
urlpatterns = [
    ...
    path("public/<int:pk>/", views.PublicCustomListView.as_view(), name="public_list"),
    path("custom/<int:pk>/toggle-public/", views.CustomListTogglePublicView.as_view(), name="custom_list_toggle_public"),
